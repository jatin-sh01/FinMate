...
Welcome to the backend repository of FinMate - your go-to platform for effortless financial management. This repository contains all the backend code necessary to power the FinMate application.

<hr/>

## Getting Started

Follow these steps to set up the FinMate backend on your local machine:
...
- The development server will start running at http://localhost:3000, and you can access FinMate's backend routes from there.
